...
func getRestaurants(latitude: Double, longitude: Double, category: String, limit: Int, term: String,
    ...
    let baseURL = "https://api.yelp.com/v3/businesses/search?latitude=\(latitude)&longitude=\(longitude)&category=\(category)&limit=\(limit)&term=\(term)"
